...
<script type="text/javascript">
	$(function(){
		...
		$("#vcodeImg").click(function(){
			this.src="CpachaServlet?method=GetLoginVCode&vl=4&w=155&h=40&t="+new Date().getTime();
		});
    ...
    <form id="form" class="form form-horizontal" method="post">
      ...
      <div class="row cl">
        <div class="formControls col-8 col-offset-3">
          ...
          <img title="点击图片切换验证码" id="vcodeImg" src="CpachaServlet?method=GetLoginVCode&vl=4&w=155&h=40"></div>
      </div>
      ...
      <div class="row">
        <div class="formControls col-8 col-offset-3">
          ...
          <a href="LoginServlet?method=registe" class="btn btn-success radius size-L" style="margin-left:165px;">&nbsp;注&nbsp;&nbsp;&nbsp;&nbsp;册&nbsp;</a>
        </div>
      </div>
    </form>
  </div>
</div>
<div class="footer">Copyright @ jiashiji </div>
